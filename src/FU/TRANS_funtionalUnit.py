...
from src.FU import BRT, shiftStations
...
class FU:
    ...
    def operation(self):
        ...
        if str(self.ss_side.type_operation).startswith("sqrt"):
            self.operationQueue[0] = math.sqrt(operand2)
        if str(self.ss_side.type_operation).startswith("log"):
            self.operationQueue[0] = math.log(operand2)
        if str(self.ss_side.type_operation).startswith("sin"):
            self.operationQueue[0] = math.sin(operand2)
        if str(self.ss_side.type_operation).startswith("sin"):
            self.operationQueue[0] = math.cos(operand2)
